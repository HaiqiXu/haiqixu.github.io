    ...
    this.jsonInit(
        {
          ...
          "args0": [
            ...
            },
            {
              ...
              "name": "unit",
              "options": [
                ["kilometers", "kilometers"], ["kilometer", "kilometer"], ["meters", "meters"], ["meter", "meter"], ["miles", "miles"], ["mile", "mile"], ["feet", "feet"], ["foot", "foot"]
              ]
            }
          ],
          "output": "np_type",
          ...
          "args0": [
            {
              ...
              "name": "subcon_aux",
              "options": [
                ["",""], ["but nt","but not"], ["that is","that is"], ["that are","that are"], ["that is not","that is not"], ["that are not","that are not"], ["that was","that was"], ["that were","that were"], ["that was not","that was not"], ["that were not","that were not"]
              ]
            },
            {
              "type": "field_dropdown",
    ...
    this.jsonInit(
        {
          ...
          "args0": [
            ...
            },
            {
              ...
              "name": "rel6_adj",
              "options": [
                ["for sale","for sale"], ["visible","visible"], ["longest","longest"], ["biggest","biggest"]
              ]
            }
          ],
          "previousStatement": "rel_type",
